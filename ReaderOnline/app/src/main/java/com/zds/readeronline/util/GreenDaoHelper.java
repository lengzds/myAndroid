...
import com.zds.readeronline.database.BookDao;
import com.zds.readeronline.database.ChapterDao;
import com.zds.readeronline.database.DaoMaster;
...
public class GreenDaoHelper extends Application {
    ...
    public static DaoMaster getDaoMaster(Context context) {
        ...
        if (daoMaster == null) {
            ...
            try{
                ...
                //适用于未加密的数据库
                //DaoMaster.OpenHelper helper = new MySQLiteOpenHelper(wrapper,"databaseHelper.db",null);
                //daoMaster = new DaoMaster(helper.getWritableDatabase()); //获取未加密的数据库

                //适用于加密的数据库
                /*MyEncryptedSQLiteOpenHelper helper = new MyEncryptedSQLiteOpenHelper(wrapper,"databaseHelper.db",null);
    ...
    private static class MySQLiteOpenHelper extends DaoMaster.OpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            MigrationHelper.migrate(db,BookDao.class, ChapterDao.class);
    ...
    /*private static class MyEncryptedSQLiteOpenHelper extends DaoMaster.OpenHelper {
        ...
        public void onUpgrade(Database db, int oldVersion, int newVersion) {
            ...
            EncryptedMigrationHelper.migrate((EncryptedDatabase) db,BookDao.class, ChapterDao.class, ProductDao.class);
            Log.e(UPGRADE,"upgrade run success");
        }
